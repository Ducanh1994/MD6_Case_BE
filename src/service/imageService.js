...
var StaffService = /** @class */ (function () {
    function StaffService() {
        var _this = this;
        this.getSubImagesByProductId = function (productID) { return __awaiter(_this, void 0, void 0, function () {
            var images, urls, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.ImageRepository.find({
                                where: {
                                    product: {
                                        id: productID
                                    }
                    ...
                    case 1:
                        images = _a.sent();
                        urls = images.map(function (image) { return image.url; });
